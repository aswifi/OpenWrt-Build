...
git clone https://github.com/kenzok8/small.git /root/temp_packages && mv /root/temp_packages/* package/ && sudo rm -rf /root/temp_packages && sudo mkdir /root/temp_packages
git clone https://github.com/kenzok8/openwrt-packages.git /root/temp_packages && mv /root/temp_packages/* package/ && sudo rm -rf /root/temp_packages
