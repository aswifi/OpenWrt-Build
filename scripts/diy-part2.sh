...
git clone https://github.com/kenzok8/small.git root/ && mv /root/small/* package/
git clone https://github.com/kenzok8/openwrt-packages.git root/ && mv /root/openwrt-packages/* package/
